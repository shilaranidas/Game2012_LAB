...
///////////////////////////////////////////////////////////////////////
//
// UniformQualifiedVariableDemo.cpp
//After the shaders have been compiledand linked, we can get the correspondence
...
//including floats, ints, and two - , three - , and four - dimensional vectors and matrices.
//For the 4 × 4 rotation matrix, we use the form glUniformMatrix4fv(matrix_loc, 1, GL_TRUE, ctm);
///////////////////////////////////////////////////////////////////////
...
void init(void)
{
	vertexShaderId = setShader((char*)"vertex", (char*)"cube6.vert");
