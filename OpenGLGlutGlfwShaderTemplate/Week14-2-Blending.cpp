...
void createTexture()
{
	...
	unsigned char* image2 = stbi_load("Media/glass.png", &width, &height, &bitDepth, 0);
	if (!image) cout << "Unable to load file!" << endl;
	...
	//unsigned char* image4 = stbi_load("Media/cube.bmp", &width, &height, &bitDepth, 0);
