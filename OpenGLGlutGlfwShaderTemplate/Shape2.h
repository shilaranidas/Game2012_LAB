...
struct Shape
{
	...
	void ColorShape(GLfloat r, GLfloat g, GLfloat b, GLfloat a)
	{
		shape_colors.clear();
		shape_colors.shrink_to_fit();
		for (int i = 0; i < shape_vertices.size(); i += 4)
		{
