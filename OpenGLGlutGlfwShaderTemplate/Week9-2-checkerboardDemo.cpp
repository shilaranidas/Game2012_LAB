...
//8 pixel black, 8 pixel white, 8 pixel black.....
...
void createChessboard(void)
{
	...
	for (i = 0; i < 64; i++)
	{
		for (j = 0; j < 64; j++)
			...
			{
				//cout << "Black"<<i << "," << j<<","<< i/8<<","<<j/8<< endl;
				chessboard[i][j][0] = 0x00;//r
				chessboard[i][j][1] = 0x00;//g
				chessboard[i][j][2] = 0x00;//b
				chessboard[i][j][3] = 0xFF;//a
			}
			else
			{
				//cout << "White" << i << "," << j << "," << i / 8 << "," << j / 8 << endl;
				chessboard[i][j][0] = 0xFF;//r
				chessboard[i][j][1] = 0xFF;//g
				chessboard[i][j][2] = 0xFF;//b
				chessboard[i][j][3] = 0xFF;//a
			}
		//cout << endl;
	}
...
void loadTexture()
{
	...
	createChessboard();
	//here informing size 64,64 and color with rgba
